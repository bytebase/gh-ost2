...
func TestGetDBUriWithTLSSetup(t *testing.T) {
	...
	uri := c.GetDBUri("test")
	require.Equal(t, `gromit:penguin@tcp(myhost:3306)/test?autocommit=true&interpolateParams=true&charset=utf8mb4_general_ci,utf8_general_ci,latin1&tls=uuidv4&timeout=1.234500s&readTimeout=1.234500s&writeTimeout=1.234500s`, uri)
}
